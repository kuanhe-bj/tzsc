...
; (function(c) {
    ...
    o = function(a) {
        ...
        s.clone = function(a, i, b) {
            var d = {};
            if (s.isArray(a) && s.isObject(i)) for (var c = 0; c < a.length; c++) d[a[c]] = b && s.isObject(i[a[c]]) ? s.clone(i[a[c]], b) : i[a[c]];
            else if (s.isObject(a)) for (c in a) d[c] = i && s.isObject(a[c]) && !a[c].ICHARTJS_OBJECT ? s.clone(a[c], i) : a[c];
            return d
        };
        ...
        s.apply(s, {
            ...
            register: function(a) {
                if (s.isString(a)) G[a.toLowerCase()] = a;
                else {
                    var i = a.get("id");
                    if (!i || "" == i) {
        ...
        s.requestAnimFrame = function() {
            var i = a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame || a.oRequestAnimationFrame || a.msRequestAnimationFrame ||
            function(i) {
        ...
        s.Event = {
            ...
            fix: function(i) {
                ...
                if ("undefined" == typeof i.offsetX) {
                    ...
                    for (var d = c = 0,
                    u = i.target; u != document.body && u;) c += u.offsetLeft - (u.scrollLeft || 0),
                    d += u.offsetTop,
                    u = u.offsetParent;
                    b.offsetX = b.pageX - c;
                    b.offsetY = b.pageY - d
    ...
    Array.prototype.each = function(a, b) {
        ...
        i, d = 0; d < c && !(i = b ? a.call(b, this[d], d) : a(this[d], d), "boolean" === typeof i && !i); d++);
        return this
    };
    ...
    Array.prototype.sor = function(a) {
        ...
        c, i = 0; i < b; i++) for (var d = b; d > i; d--) if (a ? !a(this[d], this[d - 1]) : this[d] < this[d - 1]) c = this[d],
        this[d] = this[d - 1],
        this[d - 1] = c
    };
    c.iChart = o;
    ...
    c.Legend = c.extend(c.Component, {
        ...
        drawCell: function(a, b, c, e, f, g) {
            ...
            j, e)) - 1 != f.indexOf("bar") && g.T.box(a, b - j / 12, j, j / 6, 0, e),
            "round" == f ? g.T.round(a + j / 2, b, j / 2, e) : "round-bar" == f ? g.T.round(a + j / 2, b, j / 4, e) : "square-bar" == f ? g.T.box(a + j / 4, b - j / 4, j / 2, j / 2, 0, e) : "square" == f && g.T.box(a, b - j / 2, j, j, 0, e);
        ...
        doLayout: function(a, b) {
            ...
            for (var p = 0; p < j; p++) {
                for (var g = 0,
                m = p; m < l; m += j) g = Math.max(g, a.data[m].width_);
                a.columnwidth[p] = g;
                e += g
            }
            for (p = 0; p < k; p++) {
            ...
            for (p = 0; p < k; p++) {
                ...
                g += r;
                for (m = 0; m < j && p * j + m < l; m++) e = a.data[p * j + m],
                e.y = g,
                e.x = f,
                f += a.columnwidth[m] + d;
                g += r
    ...
    c.Text = c.extend(c.Component, {
        ...
        v = function(i, b) {
            ...
            i.each(function(i) {
                ...
                if (a.isArray(d)) {
                    ...
                    for (var k = 0; k < d.length; k++) d[k] = q(d[k]),
                    j += d[k],
                    g || (c = e = d[k], g = !0),
                    c = l(d[k], c),
                    e = p(d[k], e);
            ...
            b.push("maxItemSize", f);
                ...
                var k = j.length,
                n, o, m, r = "stacked" == b.dataType;
                if (0 == k) for (var k = i[0].value.length, t = 0; t < k; t++) j.push("");
                b.columns = [];
                for (t = 0; t < k; t++) n = [],
                o = 0,
                i.each(function(b, u) {
                    if (d = b.value[t]) b.value[t] = d = q(d, d),
                    o += d,
                    r ? m = i[u].color: (m = b.color, g || (c = e = d, g = !0), c = l(d, c), e = p(d, e)),
                    n.push(a.applyIf({
                        name: b.name,
                        value: b.value[t],
                        background_color: m,
        ...
        b.prototype = {
            ...
            css: function(i, b) {
                if (a.isDefined(b)) this.canvas.style[i] = b;
                else return this.canvas.style[i]
            },
        ...
        a.Chart = a.extend(a.Painter, {
            ...
            load: function(a) {
                var b = this._();
                b.push("data", a || []);
                b.setUp(); (b.Combination ? b.root: b).draw()
            },
            resize: function(b, c) {
            ...
            initialize: function() {
                ...
                b.Rendered && !b.initialization && (c && 0 < c.length ? v.call(b, c, b) : a.isString(b.get("url")) && b.ajax.call(b, b.get("url"),
                function(a) {
                    b.push("data", a);
                    b.initialize();
                    b.draw()
            ...
            doActing: function(b, c, d, e, f) {
                ...
                k = b.getPercent(c.value, c.total);
            ...
            remove: function(a, b) {
                b && a.components.each(function(c, d) {
                    if (b.id == c.id) return a.components.splice(d, 1),
                    !1
                })
            },
            doConfig: function() {
    ...
    c.Scale = c.extend(c.Component, {
        ...
        doConfig: function() {
            ...
            if (0 < d) a.number = d - 1;
                ...
                if (!c.isNumber(j) || j < f) j = c.ceil(f),
                j = a.push("end_scale", !j && !k ? 1 : j);
            ...
            var l, p, m, r = f = e = b = j = 0,
            o = 0;
            l = a.get("scale_width");
            p = l / 2;
            m = a.get("scaleAlign");
            var t = a.get("position"),
            q = a.get("text_space"),
            v = "",
            i = a.get("coo").get("axis.width");
            ...
            p = a.isH ? a.get("valid_x") + q * a.get("distanceOne") : a.x,
            m = a.isH ? a.y: a.get("valid_y") + a.get("valid_distance") - q * a.get("distanceOne"),
            a.items.push({
                x: p,
                y: m,
                x0: p + e,
    ...
    c.Coordinate = {
        coordinate_: function(a) {
            var b = this._(),
            d = b.get("coordinate");
            if (d.ICHARTJS_OBJECT) return b.x = b.push(b.X, d.x),
            b.y = b.push(b.Y, d.y),
            b.ILLUSIVE_COO = !0,
            d;
        ...
        doConfig: function() {
            ...
            if (b) {
                ...
                a.scale.each(function(b) {
                    ...
                    w == a.O ? y = g: w == a.R ? u = -j: w == a.B ? y = -g: u = j,
    ...
    c.Pie3D = c.extend(c.Pie, {
        ...
        one: function(a) {
            ...
            lay = function(a, d, e, f) {
                j = c.quadrantd(d); (a && (0 == j || 3 == j) || !a && (2 == j || 1 == j)) && b.push({
                    g: d,
                    z: d == e,
                    x: f.x,
                    y: f.y,
    ...
    c.Column = c.extend(c.Chart, {
        ...
        engine: function(a) {
            ...
            l = l + a.get("text_space") + a.coo.get("axis.width")[2];
    ...
    c.LineSegment = c.extend(c.Component, {
        ...
        parse: function(a) {
            ...
            b.each(function(b) {
                b.x_ = b.x;
                b.y_ = b.y; ! b.ignored && e && (a.push("label.originx", b.x), a.push("label.originy", b.y - m / 2 - 1), a.push("label.text", a.fireString(a, "parseText", [a, b.value], b.value)), c.applyIf(a.get("label"), {
                    textBaseline: "bottom",
                    color: a.get("f_color")
    ...
    c.Line = c.extend(c.Chart, {
        ...
        doConfig: function() {
            ...
            a.get("crosshair.enable") && (a.pushIf("crosshair.hcross", b), a.push("crosshair.invokeOffset",
            function(b) {
            ...
            if (a.get("tip.enable") && !a.mocker && c.isFunction(a.get("tipMocker"))) {
                ...
                t,
                q,
                r = c.isNumber(r) ? 0 > r ? 0 : 1 < r ? 1 : r: null;
                a.push("tip.invokeOffset",
                function(a, b, c) {
                    if (r != null) c.top = p + (m - b) * r;
                    else {
                    ...
                    eventValid: function(b) {
                        ...
                        if (t.valid) {
                            ...
                            a.lines.each(function(a, c) {
                                q = a.isEventValid(b);
                                if (c == 0) t.minTop = t.maxTop = q.top;
                                else {
