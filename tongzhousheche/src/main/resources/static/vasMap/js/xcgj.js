...
var styleLine = {
		...
		externalGraphic : "../theme/images/whiteCar.png",
		allowRotate : true,
		graphicWidth : 32,
		graphicHeight : 32
	};
...
//				}
				$.ajax({
					type : "POST",
					url : baseURL + "etcp/etcpDataList",
					contentType : "application/json",
					async:false,
					data : JSON.stringify({'cph': vm.q.cph,'qssj':qsj,'jssj':hsj}),
					success : function(r) {
...
function zd(){
	...
	$.ajax({
		url : baseURL + "etcp/shijian",
		type : "POST",
		contentType : "application/json",
		async:false,
		data :JSON.stringify({'cph': vm.q.cph}),
		success : function(r) {
			//console.log("2222222222");
			//console.log(r);
			for(var i=0;i<r.li.length;i++){
				//console.log("2222");
				//console.log(r.li[0]);
				qsj=r.li[0];
				hsj=r.li[1];
